...
<%@ attribute name="items" type="kr.so.java.mvc.domain.BaseCodeLabelEnum[]" required="true" %>
<%@ attribute name="values" type="kr.so.java.mvc.domain.BaseCodeLabelEnum[]" required="false" %>
