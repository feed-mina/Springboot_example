    ...
    init: () => {
        ...
        $(document).on("click", "#btnUserSearchModalSave", function (e) {
            if (vm.userSearchModalType === "profsr") {
                ...
                let userInfoTag = "<div>" + userEmail + "&nbsp;&nbsp;&nbsp;" + userNm + "<button class='deleteProfessorUser' type='button'><img src='/image/close.png' class='delete-keyword-btn'/></button></div>";
                ...
                let userInfoTag = "<div>" + userEmail + "&nbsp;&nbsp;&nbsp;" + userNm + "<button class='deleteSmtmIntrprUser' type='button'><img src='/image/close.png' class='delete-keyword-btn'/></button></div>";
