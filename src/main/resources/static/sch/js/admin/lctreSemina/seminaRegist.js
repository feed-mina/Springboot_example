    ...
    init: () => {
        ...
        $(document).on("click", "#btnUserSearchModalSave", function (e) {
            if (vm.userSearchModalType === "progrs") {
                ...
                let userInfoTag = "<div>" + userEmail + "&nbsp;&nbsp;&nbsp;" + userNm + "<button class='deleteSmtmIntrprUser deleteUser' type='button'><img src='/image/close.png' class='delete-keyword-btn'/></button></div>";
